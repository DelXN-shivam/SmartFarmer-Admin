...
export default function DashboardLayout({ children }) {
  ...
  const sidebarItems = [
    { icon: Home, label: "Dashboard", href: "/district-officer" },
    {
      icon: Users,
      label: "Taluka Officer",
      href: "/district-officer/taluka-officer/all",
      subItems: [
        {
        ...
        },
        {
          ...
          href: "/district-officer/taluka-officer/add",
        },
      ],
    },
    {
      icon: BarChart3,
      label: "Analytics",
      href: "/district-officer/analytics",
      subItems: [
        { label: "Overview", href: "/district-officer/analytics" },
        { label: "Reports", href: "/district-officer/analytics/reports" },
        { label: "Export", href: "/district-officer/analytics/export" },
      ],
    },
