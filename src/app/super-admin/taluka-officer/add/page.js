...
const AddTalukaOfficers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/api/taluka-officer/register`, transformedData, {
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Add New Taluka Officer</h1>
          <p className="text-gray-600 mt-2">Fill in the details to register a new taluka officer</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 sm:p-8">
          <div className="mb-8 pb-6 border-b border-gray-200">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900">Taluka Officer Registration</h2>
            </div>
          </div>
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  <span>Adding Taluka Officer...</span>
                </>
              ) : (
                <>
                  <User className="w-5 h-5" />
                  <span>Add Taluka Officer</span>
                </>
              )}
            </button>
          </div>
...
export default AddTalukaOfficers;
