...
const AddTalukaOfficers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/api/district-officer/register`, transformedData, {
        headers: {
    ...
    return (
      <div className="w-full min-h-screen flex items-center justify-center p-4 bg-gray-50">
        <div className="w-full max-w-2xl bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">District Officer Added Successfully!</h2>
          <button
            onClick={() => setSubmitSuccess(false)}
            className="mt-6 px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors duration-200"
          >
            Add Another District Officer
          </button>
        </div>
      </div>
    )
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Add New District Officer</h1>
          <p className="text-gray-600 mt-2">Fill in the details to register a new district officer</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg p-6 sm:p-8">
          <div className="mb-8 pb-6 border-b border-gray-200">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900">District Officer Registration</h2>
            </div>
          </div>
