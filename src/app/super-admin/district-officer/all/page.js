...
export default function AllDistrictOfficers() {
  ...
  // Refresh function exactly like taluka officer dashboard
  const handleRefresh = async () => {
    ...
    try {
      ...
      await getAllDistrictOfficers();
      toast.success("District officers data refreshed successfully!");
    } catch (err) {
      console.error("Error refreshing district officers:", err);
        ...
        <div className="bg-red-50 border-l-4 border-red-500 p-4">
          <div className="flex">
            <div className="ml-3">
              ...
              <button
                onClick={getAllDistrictOfficers}
    ...
    <div className="p-4 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row justify-center items-start md:items-center mb-8 gap-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          {/* Refresh Button - Exactly like taluka officer dashboard */}
          <button
