"use client";
import { useState, useRef, useEffect } from "react"; // useEffect और useRef import जोड़ें
import {
  Menu,
  X,
  Home,
  ...
  const sidebarItems = [
    { icon: Home, label: "Dashboard", href: "/taluka-officer" },
    {
      ...
      subItems: [
        ...
        { label: "All Pending Crops", href: "/taluka-officer/crop/pending" },
        { label: "All Rejected Crops", href: "/taluka-officer/crop/rejected" },
      ],
    },
    {
      icon: Users,
        ...
        <header className="bg-white shadow-sm border-b border-gray-200">
          <div className="flex items-center justify-between h-16 px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* User dropdown - यहाँ ref add किया गया है */}
...
//   const { user, role, clearUserData } = useUserDataStore();
...
//       ],
//     },
//     // Analytics & Reports could be restricted to admin roles
//   ];
