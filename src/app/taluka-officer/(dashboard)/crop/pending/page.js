...
//   const cropsByTaluka = crops.filter(crop => 
//     crop.taluka === localStorage.getItem("taluka")
//   )

//   // Filter only pending crops
//   const pendingCrops = crops.filter(crop => 
...
//         <h1 className="text-3xl font-bold text-gray-900">Pending Crops ({pendingCrops.length})</h1>
//         <div className="flex flex-col sm:flex-row w-full md:w-auto gap-4">
//           <div className="relative w-full sm:w-auto">
//             <Input
//               type="text"
//               placeholder="Search pending crops..."
//               className="w-full md:w-80 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500"
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//             />
//             {searchTerm && (
...
//             disabled={refreshing}
//             className="flex items-center justify-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed"
//           >
//             <RefreshCw className={`h-5 w-5 mr-2 ${refreshing ? 'animate-spin' : ''}`} />
//             Refresh
//           </button>
...
// //   const getPendingCrops = useCallback(async () => {
// //     try {
// //       setLoading(true)
// //       setError(null)
// //       const token = localStorage.getItem("Authorization")?.split(" ")[1]
...
// //         // Filter only pending crops
// //         const pendingCrops = response.data.crops.filter(crop => 
// //           crop.applicationStatus === 'pending'
// //         )
...
// //     return (
// //       <div className="p-4 max-w-7xl mx-auto">
// //         <h1 className="text-3xl font-bold text-gray-900 mb-4">Pending Crops</h1>
// //         <div className="bg-red-50 border-l-4 border-red-500 p-4">
// //           <div className="flex">
// //             <div className="ml-3">
// //               <p className="text-sm text-red-700">{error}</p>
// //               <button
// //                 onClick={getPendingCrops}
...
// //     <div className="p-4 max-w-7xl mx-auto">
// //       <div className="flex flex-col md:flex-row justify-center items-start md:items-center mb-8 gap-16">
// //         <h1 className="text-3xl font-bold text-gray-900">Pending Crops</h1>
// //         <div className="flex flex-col sm:flex-row w-full md:w-auto gap-4">
// //           {/* Search Input */}
// //           <div className="relative w-full sm:w-auto">
// //             <Input
