...
const CropCard = ({ crops }) => {
  ...
  const handleViewVerifier = (crop, e) => {
    ...
    // Mock verifier data - replace with actual API call
    const verifierData = {
              ...
              <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">
                      <span className={`px-2 py-1 rounded-full text-xs ${getStatusBadgeClass(farmer.status)}`}>
                        {farmer.status}
                      </span>
                    </p>
                  </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900 text-2xl">
                      {Math.round((farmer.verifiedCrops / farmer.totalCrops) * 100)}%
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">
                      <span className={`px-2 py-1 rounded-full text-xs ${getStatusBadgeClass(verifier.status)}`}>
                        {verifier.status}
                      </span>
                    </p>
                  </div>
              ...
              <div className="flex items-center justify-center">
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-600 mt-1">
                    This verifier has been certified by the Agricultural Verification Board and meets all quality standards.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden flex flex-col">
          ...
          <div className={`relative p-6 ${
            crop.applicationStatus === 'verified' ? 'bg-gradient-to-r from-green-800 to-green-900' :
            crop.applicationStatus === 'pending' ? 'bg-gradient-to-r from-yellow-700 to-yellow-800' :
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">
                      <span className={`px-2 py-1 rounded-full text-xs ${getStatusBadgeClass(crop.applicationStatus)}`}>
              ...
              <div className="bg-amber-50 rounded-xl p-6 border border-amber-200">
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <p className="font-semibold text-gray-900">
                      {crop.expectedFirstHarvestDate ? formatDate(crop.expectedFirstHarvestDate) : "N/A"}
                    </p>
                  </div>
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    <Label className="text-sm text-gray-500">
                    ...
                    <p className="font-semibold text-gray-900">
                      {crop.expectedLastHarvestDate ? formatDate(crop.expectedLastHarvestDate) : "N/A"}
                    </p>
                  </div>
                  <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    <Label className="text-sm text-gray-500">
                    ...
                    <p className="font-semibold text-gray-900">
                      {crop.expectedYield?.value || "N/A"} {crop.expectedYield?.unit || ""}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 bg-blue-50 rounded-xl p-6 border border-blue-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                  ...
                  <p className="font-semibold text-gray-900">
                    {crop.latitude?.toFixed(6) || "N/A"}, {crop.longitude?.toFixed(6) || "N/A"}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-200">
                ...
                <div className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={() => handleViewFarmer(crop, { stopPropagation: () => {} })}
                  >
              ...
              <div className="bg-purple-50 rounded-xl p-6 border border-purple-200">
                ...
                <div className="space-y-4">
                  ...
                  <Button 
                    ...
                    onClick={() => crop.verifierId && handleViewVerifier(crop, { stopPropagation: () => {} })}
                  >
            ...
            <CardContent className="p-0">
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge className={`ml-2 ${getStatusBadgeClass(crop.applicationStatus)}`}>
                    {crop.applicationStatus}
                  </Badge>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span>{crop.area?.value} {crop.area?.unit}</span>
                  </div>
                  
                  <div className="flex items-center text-sm text-gray-600">
                    <Package className="w-4 h-4 mr-2 text-amber-600" />
                    <span>Yield: {crop.expectedYield?.value} {crop.expectedYield?.unit}</span>
                  </div>
                  
                  <div className="flex items-center text-sm text-gray-600">
                    <Calendar className="w-4 h-4 mr-2 text-blue-600" />
                    <span>Sown: {crop.sowingDate ? formatDate(crop.sowingDate) : "N/A"}</span>
                  </div>
...
// import { useState } from "react"
// import { X, Calendar, MapPin, Package, Ruler, Sprout } from "lucide-react"
// import { Badge } from "@/components/ui/badge"
// import { Button } from "@/components/ui/button"
// import { Card, CardContent } from "@/components/ui/card"
// import { Label } from "@/components/ui/label"
...
//         <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-hidden flex flex-col">
//           {/* Header */}
//           <div className="relative bg-gradient-to-r from-green-800 to-green-900 p-6">
//             <div className="absolute inset-0 bg-black/10"></div>
//             <div className="relative flex items-center justify-between text-white">
//               <div className="flex items-center space-x-4">
//                 <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border-2 border-white/30">
